...
public class NetworkUT {
    private static NetworkUT networkUT = null;
    public final int NETWORK_WIFI = 1;    // wifi network
    public final int NETWORK_4G = 4;    // "4G" networks
    public final int NETWORK_3G = 3;    // "3G" networks
    public final int NETWORK_2G = 2;    // "2G" networks
    public final int NETWORK_UNKNOWN = 5;    // unknown network
    public final int NETWORK_NO = -1;   // no network
    ...
    public synchronized static NetworkUT getInstance() {
        if (networkUT == null) {
            networkUT = new NetworkUT();
        }
        return networkUT;
    }
