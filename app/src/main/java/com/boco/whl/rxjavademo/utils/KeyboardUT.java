 ...
 * </pre>
 */
public class KeyboardUT {

    private static KeyboardUT keyboardUT = null;

    private KeyboardUT() {
    }

    public synchronized static KeyboardUT getInstance() {
        if (keyboardUT == null) {
            keyboardUT = new KeyboardUT();
        }
        return keyboardUT;
    }
     ...
     * <p>参照以下注释代码</p>
     */
    public void clickBlankArea2HideSoftInput0() {
     ...
     * <p>参照以下注释代码</p>
     */
    public void clickBlankArea2HideSoftInput1() {
        Log.i("tips", "U should copy the following code.");
        /*
        @Override
     ...
     * @param edit    输入框
     */
    public void toggleSoftInput(Context context, EditText edit) {
        edit.setFocusable(true);
        edit.setFocusableInTouchMode(true);
        edit.requestFocus();
        InputMethodManager inputManager = (InputMethodManager) context
