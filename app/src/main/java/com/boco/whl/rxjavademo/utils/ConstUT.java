 ...
 * </pre>
 */
public class ConstUT {
    private static ConstUT constUT = null;
    /**
     * Byte与Byte的倍数
     */
     ...
     * 毫秒与毫秒的倍数
     */
    public final int MSEC = 1;
    /**
     * 秒与毫秒的倍数
     */
    public final int SEC = 1000;
    /**
     * 分与毫秒的倍数
     */
     ...
     * <p>虚拟运营商：170</p>
     */
    public final String REGEX_MOBILE_EXACT = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,3,5-8])|(18[0-9])|(147))\\d{8}$";
    /**
     * 正则：电话号码
     */
     ...
     * 正则：身份证号码15位
     */
    public final String REGEX_IDCARD15 = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";

    /******************** 正则相关常量 ********************/
    /**
     * 正则：身份证号码18位
     */
    public final String REGEX_IDCARD18 = "^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9Xx])$";
    /**
     * 正则：邮箱
     */
     ...
     * 正则：URL
     */
    public final String REGEX_URL = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?";
    /**
     * 正则：汉字
     */
    public final String REGEX_CHZ = "^[\\u4e00-\\u9fa5]+$";
    /**
    ...
    public synchronized static ConstUT getInstance() {
        if (constUT == null) {
            constUT = new ConstUT();
        }
        return constUT;
